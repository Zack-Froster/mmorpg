...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable
    {
        ...
        public UnityAction<Result> OnPanelChange;
        ...
        void OnUserRegister(object sender, UserRegisterResponse response)
        {
            ...
            if (this.OnRegister != null)
            {
                ...
                this.OnPanelChange(response.Result);
            }
        }
        ...
        void OnUserLogin(object render, UserLoginResponse response)
        {
            Debug.LogFormat("OnUserLogin:user:{0}   {1}", response.Result, response.Errormsg);
        ...
        {
            Debug.LogFormat("SendCharacterCreate:characterName:{0}   characterClass:{1}", characterName, characterClass);
            NetMessage message = new NetMessage();
            message.Request = new NetMessageRequest();
