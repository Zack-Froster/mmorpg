...
namespace GameServer.Models
{
    class Guild
    {
        ...
        internal bool JoinApply(NGuildApplyInfo apply)
        {
            ...
            DBService.Instance.Entities.GuildApplies.Create();
        ...
        internal void ExecuteAdmin(GuildAdminCommand command, int targetId, int sourceId)
        {
            ...
            switch (command)
            {
                ...
                case GuildAdminCommand.Kickout:
                    ...
                    var removeItem = DBService.Instance.Entities.GuildMembers.FirstOrDefault(v => v.Id == target.Id);
                    if (removeItem != null)
                    {
